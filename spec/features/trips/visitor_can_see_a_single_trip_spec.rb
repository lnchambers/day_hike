...
describe "As a visitor" do
  before :each do
    @trail = Trail.create!(name: "Opakawagalaga", length: 12, address: "123 Eupanifahorious Way")
    @trail_2 = Trail.create!(name: "Eupanifahorious", length: 15, address: "123 Opakawagalaga Way")
